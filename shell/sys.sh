...
function show_main_menu() {
    while true; do
        clear
        echo_color green "========================================"
        echo_color green "         Jcole 的 VPS 管理工具       "
        echo_color green "========================================"
        echo_color green "1. 系统信息查询"
        echo_color green "2. 系统清理"
        echo_color green "3. 修改主机名"
        echo_color green "4. 优化 DNS"
        echo_color green "5. 设置网络优先级"
        echo_color green "6. 设置 SSH 密钥登录"
        echo_color green "7. 设置系统时区"
        #echo_color green "8. 设置快捷键"
        echo_color green "----------------------------------------"
        echo_color green "9. Sing-Box管理"
        echo_color green "10. 安装 S-ui"
        echo_color green "11. 安装 3X-ui"
        echo_color green "----------------------------------------"
        echo_color green "88. 退出"
        echo_color green "00. 更新脚本"
        echo_color green "========================================"
        echo
        read -p "请输入选项: " option
        case $option in
